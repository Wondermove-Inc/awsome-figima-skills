...
Read `<figma-visual-researcher-skill-dir>/SKILL.md` before doing the work. Read
`<figma-visual-researcher-skill-dir>/references/contracts.md` when you need the exact JSON contract.
